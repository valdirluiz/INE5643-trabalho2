...
-- Wed 15 Nov 2017 05:12:37 PM BRST
...
-- -----------------------------------------------------
-- Table `analitico`.`dm_vestibular`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `analitico`.`dm_vestibular` (
  `seq_vestibular` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `analitico`.`dm_candidato` (
  ...
  `possui_computador` VARCHAR(45) NULL,
  `grau_instrucao_pai` VARCHAR(50) NULL,
  `grau_instrucao_mae` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `analitico`.`dm_estabelecimento_ensino` (
  `seq_estabelecimento_ensino` INT(11) NOT NULL,
  `nome_estabelecimento` VARCHAR(45) NULL,
  `rede` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `analitico`.`dm_tempo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `analitico`.`dm_tempo` (
  `seq_tempo` INT(11) NOT NULL,
  `ano_evento` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `analitico`.`ft_desempenho` (
  ...
  `dm_tempo_seq` INT(11) NOT NULL,
  `dm_curso_seq` INT(11) NOT NULL,
  `media_acertos_geral` DECIMAL(5,2) NULL,
  `classificacao_geral` DECIMAL(6,0) NULL,
  ...
  PRIMARY KEY (`dm_vestibular_seq`, `dm_estabelecimento_ensino_seq`, `dm_candidato_seq`, `dm_curso_seq`, `dm_tempo_seq`),
  INDEX `fk_ft_desempenho_dm_candidato1_idx` (`dm_candidato_seq` ASC),
  INDEX `fk_ft_desempenho_dm_tempo1_idx` (`dm_tempo_seq` ASC),
  ...
  CONSTRAINT `fk_ft_desempenho_dm_vestibular`
    ...
    REFERENCES `analitico`.`dm_vestibular` (`seq_vestibular`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_ft_desempenho_dm_candidato1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ft_desempenho_dm_tempo1`
    FOREIGN KEY (`dm_tempo_seq`)
    REFERENCES `analitico`.`dm_tempo` (`seq_tempo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
